...
void initEnemy(Enemy *e, int x, int y, SDL_Renderer *renderer)
{
    ...
    surf = IMG_Load("/home/khalil/op/avatar-game-khalilB7-version2/strengh and wisdom/avatar-game-khalilB7-version2/the game/images/stop.png");
    e->framesRight[0] = surf ? SDL_CreateTextureFromSurface(renderer, surf) : NULL;
    if (surf) SDL_FreeSurface(surf);

    surf = IMG_Load("/home/khalil/op/avatar-game-khalilB7-version2/strengh and wisdom/avatar-game-khalilB7-version2/the game/images/left.png");
    e->framesRight[1] = surf ? SDL_CreateTextureFromSurface(renderer, surf) : NULL;
    if (surf) SDL_FreeSurface(surf);

    surf = IMG_Load("/home/khalil/op/avatar-game-khalilB7-version2/strengh and wisdom/avatar-game-khalilB7-version2/the game/images/right.png");
    e->framesRight[2] = surf ? SDL_CreateTextureFromSurface(renderer, surf) : NULL;
    if (surf) SDL_FreeSurface(surf);

    surf = IMG_Load("/home/khalil/op/avatar-game-khalilB7-version2/strengh and wisdom/avatar-game-khalilB7-version2/the game/images/attack.png");
